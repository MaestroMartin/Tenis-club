<?php
// source: /mnt/c/Users/pelma/Desktop/Tenis-club/config/common.neon
// source: /mnt/c/Users/pelma/Desktop/Tenis-club/config/services.neon
// source: array
...
class Container_c69fc1eee9 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\FrontModul\Presenters\ReservationManager' => [['02']],
		'App\UI\FrontModul\Presenters\UserManager' => [['03']],
		'Nette\Security\Authorizator' => [['04']],
		'Nette\Security\Permission' => [['04']],
		'App\UI\User\Sign\ControlFactory' => [['05']],
		'Nette\Application\UI\Control' => [
			2 => ['06', '011', '012', 'application.1', 'application.3', 'application.4', 'application.5', 'application.6'],
		],
		...
		'Nette\Application\UI\Presenter' => [
			2 => ['011', '012', 'application.1', 'application.3', 'application.4', 'application.5', 'application.6'],
		],
		...
		'App\UI\FrontModul\Presenters\BasePresenter' => [2 => ['012', 'application.4']],
		'App\UI\FrontModul\Presenters\ReservationPresenter' => [2 => ['012']],
		...
		'App\UI\Model\SignPresenter' => [2 => ['application.5', 'application.6']],
		'App\UI\FrontModul\Presenters\SignPresenter' => [2 => ['application.5']],
		'NetteModule\ErrorPresenter' => [2 => ['application.7']],
		'NetteModule\MicroPresenter' => [2 => ['application.8']],
		'App\UI\Model\AuthorizatorFactory' => [['013']],
		'App\UI\Model\BaseManager' => [['014']],
		'App\UI\Model\RoleFacade' => [['014']],
		'App\Model\UserFacade' => [['015']],
		'App\Core\FormFactory' => [['016']],
	];
	...
	public function createService02(): App\UI\FrontModul\Presenters\ReservationManager
	{
		return new App\UI\FrontModul\presenters\ReservationManager($this->getService('database.default.explorer'));
	}


	public function createService03(): App\UI\FrontModul\Presenters\UserManager
	{
		return new App\UI\FrontModul\presenters\UserManager($this->getService('database.default.explorer'));
	}


	public function createService04(): Nette\Security\Permission
	{
		return App\UI\model\AuthorizatorFactory::create();
	}


	public function createService05(): App\UI\User\Sign\ControlFactory
	{
		return new class ($this) implements App\UI\User\Sign\ControlFactory {
			public function __construct(
				private Container_c69fc1eee9 $container,
			) {
			}


			public function create(callable $onSuccess): App\UI\User\Sign\Control
			{
				return new App\UI\User\Sign\Control($this->container->getService('07'), $this->container->getService('07'), $onSuccess);
			}
		};
	}


	public function createService06(): App\UI\User\Sign\Control
	{
		return new App\UI\User\Sign\Control($this->getService('07'), $this->getService('07'));
	}


	public function createService07(): App\UI\User\Sign\FormFactory
	{
		return new App\UI\User\Sign\FormFactory($this->getService('security.user'), $this->getService('016'), $this->getService('05'));
	}


	public function createService08(): App\UI\Model\AddReservationManager
	{
		return new App\UI\Model\AddReservationManager($this->getService('database.default.explorer'));
	}


	public function createService09(): App\UI\Model\UserManager
	{
		return new App\UI\Model\UserManager($this->getService('database.default.explorer'));
	}
	...
	public function createService011(): App\UI\FrontModul\Presenters\UserPresenter
	{
		$service = new App\UI\FrontModul\presenters\UserPresenter($this->getService('015'), $this->getService('database.default.explorer'));
	...
	public function createService012(): App\UI\FrontModul\Presenters\ReservationPresenter
	{
		$service = new App\UI\FrontModul\presenters\ReservationPresenter($this->getService('02'), $this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createService013(): App\UI\Model\AuthorizatorFactory
	{
		return new App\UI\Model\AuthorizatorFactory;
	}


	public function createService014(): App\UI\Model\RoleFacade
	{
		return new App\UI\Model\RoleFacade($this->getService('database.default.explorer'));
	}


	public function createService015(): App\Model\UserFacade
	{
		return new App\Model\UserFacade($this->getService('database.default.explorer'), $this->getService('security.passwords'));
	}


	public function createService016(): App\Core\FormFactory
	{
	...
	public function createServiceApplication__4(): App\UI\FrontModul\presenters\HomePresenter
	{
		$service = new App\UI\FrontModul\presenters\HomePresenter($this->getService('08'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\UI\FrontModul\Presenters\SignPresenter
	{
		$service = new App\UI\FrontModul\Presenters\SignPresenter($this->getService('05'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
		...
		$service->injectUserSignInFormFactory($this->getService('05'));
	...
	public function createServiceApplication__6(): App\UI\Model\SignPresenter
	{
		$service = new App\UI\Model\SignPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/mnt/c/Users/pelma/Desktop/Tenis-club/temp/cache/nette.application/touch',
		));
		$service->setMapping(['*' => 'App\UI\FrontModul\presenters\*Presenter']);
		return $service;
	}
	...
	{
		return new Nette\Caching\Storages\FileStorage('/mnt/c/Users/pelma/Desktop/Tenis-club/temp/cache');
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1.;dbname=Tenis',
			/*sensitive{*/'testuser'/*}*/,
			/*sensitive{*/'Testpassword1!'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/mnt/c/Users/pelma/Desktop/Tenis-club/temp/cache/latte');
