...
final class Template_6bf425b4c7 extends Latte\Runtime\Template
{
...
';
		foreach ($reservations as $reservation) /* line 18 */ {
			...
			echo LR\Filters::escapeHtmlQuotes($reservation->color) /* line 19 */;
			echo '">
                    <td>';
			...
			echo ':00</td>
                    <td>';
			echo LR\Filters::escapeHtmlText($reservation->end_time) /* line 25 */;
			echo ':00</td>
                    <td>
                        <a href="';
...
';
        ...
        <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('admin:settings')) /* line 33 */;
