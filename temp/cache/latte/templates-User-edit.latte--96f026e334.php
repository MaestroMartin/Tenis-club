...
final class Template_96f026e334 extends Latte\Runtime\Template
{
...
';
			...
			echo '            <p>if you get back on edit, please chose another username</p>
            <button type="submit" class="btn btn-success">Save</button>
            <a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('default')) /* line 27 */;
			echo '" class="btn btn-primary">Back</a>
        ';
			echo Nette\Bridges\FormsLatte\Runtime::renderFormEnd(array_pop($this->global->formsStack)) /* line 28 */;
